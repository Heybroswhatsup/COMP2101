...
function displayhelp {
  ...
  echo "  --ipconfig        display IP address information"
...
function cleanup {
  rm -f /tmp/*info.$$ /tmp/sysreport.$$
  echo "Temporary files deleted."
  exit 1
}

# Trap interrupts and run the cleanup function
# Define the cleanup function
cleanup() {
  echo "Cleaning up..."
  # Put your cleanup commands here
}
...
function getipinfo {
  # call netid.sh script using its absolute path
     /home/subash/COMP2101/bash/netid.sh
